        ...
        <div className="container mx-auto max-w-md bg-white shadow-lg rounded-xl p-8">
          ...
          <form>
            ...
            <p className="text-center mt-4">
              <Link href="#" className="text-[#FF9F0D] hover:text-blue-500">Forgot password?</Link> or <Link href="/signup" className=" hover:text-blue-500 text-yellow-500 hover:text-bue-500">Sign Up</Link>
            </p>
          </form>

          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {images.map((image, index) => (
              <div key={index} className="bg-white rounded-xl shadow-md overflow-hidden transform transition-transform hover:scale-105">
                ...
                <div className="p-4">
                <a  href="/shop-details" rel="noopener noreferrer"> <h3 className="text-lg font-semibold mb-2">
                       Fresh Lime</h3></a>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <span className="text-[#FF9F0D] text-xl font-bold">$28.00</span>
                      <span className="text-gray-400 line-through">$35.00</span>
                    </div>
        ...
        <div className="w-full lg:w-1/4 space-y-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <div className="flex gap-2">
              ...
              />
              <Button className="bg-[#FF9F0D] hover:bg-[#e68906] px-6 rounded-xl">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <Button className="w-full bg-[#FF9F0D] hover:bg-[#e68906] rounded-xl">
                Apply Filter
              </Button>
            </div>
          </div>
            ...
            <div className="space-y-4">
              {Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="flex gap-4 items-center">
                  ...
                  <div>
                    <h3 className="font-medium">Standard Pizza</h3>
                    <StarRating />
                    <p className="text-[#FF9F0D] font-semibold">$35.00</p>
                  </div>
                </div>
              ))}
            </div>

            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <div className="flex space-x-2">
                ...
                <Button 
                  ...
                  className="bg-[#FF9F0D] hover:bg-gray-600 hover:text-white rounded-xl"
                >
                  Apply
                </Button>
              </div>
          ...
          <div className="lg:w-96">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <div className="space-y-3">
                ...
                <a href='/checkOut'><Button className="w-full bg-[#FF9F0D] hover:bg-gray-600 hover:text-white mt-6 rounded-xl">
                  Proceed to Checkout
                </Button></a>
              </div>
            </div>

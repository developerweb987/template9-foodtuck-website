          ...
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            ...
            <div className="lg:w-1/2 w-full space-y-8 pt-4 lg:pt-12">
              <div className="space-y-2">
                <h2 className={`${VibeFont.className} text-base md:text-4xl text-[#FF9F0D] italic`}>
              ...
              <div className="flex flex-wrap gap-6">
                <Button 
                  className="bg-orange-400 hover:bg-orange-500 text-white px-8 py-6 h-auto text-base font-medium rounded-xl"
                >
                  Show More
                </Button>
                <Button 
                  className="text-gray-800  hover:bg-orange-400 hover:text-white px-6 h-auto text-base font-medium rounded-xl"
                >

          ...
          <div className="lg:w-1/2">
            <div className="relative group">
              <Image
                ...
                width={550}
                height={550}
                className="w-550 max-w-2xl mx-auto rounded-lg transition-transform duration-300 group-hover:scale-105"
              />
            ...
            <div className="space-y-4">
              {[...Array(4)].map((_, i) => (
                <MenuItem
                  ...
                  image="/homeManu1.png"
                  title="Glow Cheese"
                  description="Keep Your Business in restaurant"
                  price="10.50"
                />
              ))}
            </div>
            ...
            <div className="space-y-4">
              {[...Array(4)].map((_, i) => (
                <MenuItem
                  ...
                  image="/homeManu2.png"
                  title="Lettuce Leaf"
                  description="Keep Your Business in hotel view"
                  price="12.50"
                />
              ))}
            </div>

...
const BlogCard: FC<BlogCardProps> = ({
  ...
  return (
    <div className='w-full md:w-[900px] transform transition-transform duration-300 hover:scale-[1.02] mb-8 bg-white shadow-lg rounded-xl overflow-hidden'>
      {/* Image Section */}
      <div className='relative w-full h-[300px] md:h-[400px]'>
        {/* Label */}
        <div className='absolute top-4 left-4 bg-[#FF9F0D]transparent text-white px-4 py-2 text-sm font-medium rounded-md- z-10 shadow-md'>
          {date}
        </div>
        <Image
          src={imageSrc}
      ...
      <div className='p-6'>
        ...
        {/* Read More Button */}
        <Button className='mt-6 group flex items-center px-4 py-2 border-2 border-[#FF9F0D] rounded-xl text-[#FF9F0D] hover:bg-[#FF9F0D] hover:text-white transition-all duration-300'>

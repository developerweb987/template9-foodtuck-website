          ...
          <div className="w-full lg:w-[425px] space-y-6 md:space-y-8">
            ...
            <div className="relative">
              <Input
                ...
                className="w-full h-14 md:h-[70px] pl-6 pr-16 border border-gray-300 bg-white-800 text-gray-500 rounded-lg focus:ring-2 focus:ring-[#FF9F0D] focus:border-gray-500"
              />
            ...
            <div className="bg-white border border-gray-300 p-4 md:p-6 rounded-lg text-center">
              ...
              <h3 className="text-lg md:text-xl font-bold text-gray mb-2">
                Prince Miyako
              </h3>
            ...
            <div className="bg-white border border-gray-300 p-4 md:p-6 rounded-lg">
              ...
              <div className="flex flex-wrap gap-2">
                {["Burger", "Pizza", "Sandwich", "Pasta", "Fries", "Shake", "Salad", "Soup", "Tacos", "Burrito", "Nachos", "Wrap"].map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1 text-sm bg-[#FF9F0D] rounded-xl cursor-pointer hover:bg-amber-400 transition-colors"
                  >
                    {tag}
                  </span>
                ))}
